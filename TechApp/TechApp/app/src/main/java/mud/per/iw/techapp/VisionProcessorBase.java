...
import mud.per.iw.techapp.BitmapUtils;
import mud.per.iw.techapp.FrameMetadata;
import mud.per.iw.techapp.GraphicOverlay;
import mud.per.iw.techapp.VisionImageProcessor;
...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    @Override
    public void process(ByteBuffer data, FrameMetadata frameMetadata, mud.per.iw.techapp.GraphicOverlay graphicOverlay) throws FirebaseMLException {
        latestImage = data;
    ...
    @Override
    public void process(Bitmap bitmap, mud.per.iw.techapp.GraphicOverlay graphicOverlay) {
